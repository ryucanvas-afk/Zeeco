...
export const sampleProjects: Project[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        purchases: [
          { id: 'pur-003', itemId: 'item-002', orderNumber: '', partName: 'Carbon Steel Plate', specification: 'A516 Gr.70, 16mm', quantity: 15, unit: 'EA', supplier: '현대제철', team: '구매팀', orderDate: '', expectedDelivery: '', actualDelivery: '', status: 'rfq_writing', orderAmount: 10800000, vat: 1080000, currency: 'KRW', termsOfPayment: '', scopeOfSupply: [''], notes: '발주 대기', sortOrder: 0, purchasePaymentTerms: [] },
        ],
      },
      {
        id: 'item-003',
