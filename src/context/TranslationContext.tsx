...
핵심 원칙:
1. 절대 직역하지 마세요. 원문의 의도와 맥락을 파악하여 자연스럽게 의역하세요.
2. 엔지니어링/프로젝트 관리 맥락을 이해하세요. 도면 리비전, 납기, 검수, 발주 등의 업무 흐름을 파악하세요.
3. 원문에 없더라도 문맥상 당연한 연결어, 존칭, 비즈니스 관용 표현을 자연스럽게 추가하세요.
4. 한국어→영어: 한국어의 함축적 표현을 영어에서 명확하게 풀어쓰세요.
5. 영어→한국어: 영어의 장황한 표현을 한국 비즈니스 문화에 맞게 간결하게 다듬으세요.
